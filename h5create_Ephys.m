function h5create_Ephys(Filename,Dataset,Size,varargin)
%H5CREATE  Create HDF5 dataset.
% modified to accept more parameters
...
p.addParamValue('MaxSize',[], ...
    @(x) validateattributes(x,{'double'},{'row','nonnegative'},'','MAXSIZE'));
...
p.addParamValue('Filters','none', ...
    @(x) validateattributes(x,{'char'},{'nonempty'},'','FILTERS'));
